// components/NewsIntro.jsx
import React from "react";

const NewsIntro = ({ pageName, tagline, imageUrl }) => (
  <div className="relative w-full bg-[#EB6F63] text-white py-20 px-8 shadow-lg">
    <div className="flex flex-col md:flex-row items-center space-y-8 md:space-y-0 md:space-x-12 animate-fadeIn">
      ...
      <div className="text-center md:text-left flex-1 space-y-6">
        <h1 className="text-event-title font-bold tracking-tight leading-tight">
          {pageName}
        </h1>

        <p className="text-event-description font-medium leading-relaxed max-w-2xl">
          {tagline}
