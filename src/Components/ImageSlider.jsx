...
export default function ImageSlider() {
  ...
  return (
    <>
      ...
      <div className="relative w-full flex  glide-03">
        {/*    <!-- Slides --> */}
        <div className="overflow-hidden" data-glide-el="track">
          <ul className="whitespace-no-wrap flex-no-wrap [backface-visibility: hidden] [transform-style: preserve-3d] [touch-action: pan-Y] [will-change: transform] relative flex w-full overflow-hidden p-0">
            <li>
              <img
                src="https://res.cloudinary.com/ddnis6cuk/image/upload/f_auto,q_auto/v1/Alumni/v8ov3j1zc0r2hulqeakz"
                className="w-full max-w-full max-h-full m-auto"
              />
            </li>
            <li>
              <img
                src="https://res.cloudinary.com/ddnis6cuk/image/upload/f_auto,q_auto/v1/Alumni/u2pwp3itruznlvfpzsed"
                className="w-full max-w-full max-h-full m-auto"
              />
            </li>
            <li>
            ...
            <li>
              <img
                src="https://res.cloudinary.com/ddnis6cuk/image/upload/f_auto,q_auto/v1/Alumni/vda8hjlt28acddpk3hbp"
                className="w-full max-w-full max-h-full m-auto"
              />
            </li>
            <li>
