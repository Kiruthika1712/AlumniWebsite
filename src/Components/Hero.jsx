...
const Hero = () => {
  ...
  return (
    <div>
      <section className="pt-20 md:pt-10 py-6 ">
            <div className="container mx-auto px-8 lg:flex">
                <div className="text-center lg:text-left lg:w-1/2">
                    <h1 className="font-playfair text-4xl ml-4 lg:text-5xl xl:text-6xl font-bold leading-none">Stay Connected, Share Your Story, Inspire Others</h1>
                    <p className="font-lora text-xl lg:text-2xl mt-4 ml-4 font-light text-justify">Welcome to TechRoots Alumni Network—where connections thrive, stories inspire, and growth is celebrated. 
                        Reconnect, mentor, and stay updated with your vibrant alumni community!</p>
                    <p className="mt-8 md:mt-4 font-lora ml-4 text-2xl"><button
                        type="button"
                        className="
                            py-4 px-12
                            bg-primary
                    ...
                    <p className="font-lora mt-4 text-gray-600 ml-4 text-xl">It’s time to reconnect and make an impact</p>
                </div>
                <div className="lg:w-1/2"><svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
                        xlink="http://www.w3.org/1999/xlink" viewBox="0 0 1167.52 754.06">
                        <defs>
                            <linearGradient id="a" x1="588.17" y1="805.69" x2="588.17" y2="186.69"
                            ...
                            <linearGradient id="e" x1="463.15" y1="767.98" x2="463.15" y2="572.32"
                                gradientTransform="matrix(-.98 .22 .22 .98 532.3 -45.53)" xlink:href="#a"></linearGradient>
                        </defs>
                        <g opacity=".2">
                            <path
                        ...
                        <path
                            ...
                            fill="#fff"></path>
                        <path d="M211.93 143.72v585.31H100.27a17.26 17.26 0 01-17.26-17.26v-568z" fill="#d7d9e1"></path>
                        <path d="M1061.01 125.59v24.94h-978v-24.94a8.56 8.56 0 018.56-8.56h960.88a8.56 8.56 0 018.56 8.56z"
                            fill="#ededf4"></path>
                        ...
                        <path transform="rotate(90 670.53 129.08)" fill="url(#b)" d="M640.17 170.69h4v6h-4z"></path>
                        <path
                        ...
                        <path fill="#3f3d56" d="M768.43 727.12v-7.46l137.29-1.32-.13 5.05H770.91v3.73h-2.48z"></path>
                        ...
                        <path d="M872.86 722.15l8.16 18.44a1.58 1.58 0 002.87.06l9.69-19.74z" fill="#3f3d56"></path>
                        ...
                        <path
                            ...
                            opacity=".1"></path>
                        <path d="M631.54 547.8l5.84 2.87.12-1.25.08-.87s-3.38-2.9-4.38-2.79a5.36 5.36 0 01-1.52 0l-.07 1z"
                            fill="#dce6f2"></path>
                        <path
                        ...
                        <path
                            ...
                            fill="#4299e1"></path>
                        <path opacity=".1" d="M258.205 656.217l-79.962 18.167-18.167-79.962 79.962-18.167z"></path>
                        <path fill="#ededf4" d="M259.704 653.832l-79.962 18.167-18.167-79.962 79.962-18.167z"></path>
                        <path
                            d="M233.94 615.86a22.58 22.58 0 00-27-17c-.57.13-1.16.29-1.68.45l5.38 23.64 23.64-5.37c-.1-.55-.21-1.15-.34-1.72z"
                            fill="#4299e1"></path>
                        <path d="M231.65 621.73L208 627.1l-5.37-23.64a22.57 22.57 0 1029 18.27z" fill="#4299e1"></path>
                        <path
